...
export default function page() {
  return (
    <div className="py-4">
      <div className="text-3xl flex justify-center py-6">
        Terms and Conditions
      </div>
      <div className="flex justify-center">
        <div className="max-w-3xl">
          <h2 className="text-xl pt-8">Terms and Conditions</h2>
          <p>Last updated: September 20, 2023</p>
          <p>
            Please read these terms and conditions carefully before using Our
            Service.
          </p>
          <h2 className="text-xl pt-8">Interpretation and Definitions</h2>
          <h3 className="text-lg">Interpretation</h3>
          <p>
          ...
          <h3 className="text-lg">Definitions</h3>
          ...
          <ul>
            ...
            <li>
              <p>
                <strong>Country</strong> refers to: Schleswig-Holstein, Germany
              </p>
            </li>
            <li>
              <p>
                ...
                in this Agreement) refers to Cryptoreach.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to Cryptoreach, accessible from{' '}
                <a
                  href="https://cryptoreach.xyz"
                  rel="external nofollow noopener"
                  target="_blank"
                >
                  https://cryptoreach.xyz
                </a>
              </p>
            </li>
            <li>
          ...
          <h2 className="text-xl pt-8">Acknowledgment</h2>
          <p>
          ...
          <h2 className="text-xl pt-8">Links to Other Websites</h2>
          <p>
          ...
          <h2 className="text-xl pt-8">Termination</h2>
          <p>
          ...
          <h2 className="text-xl pt-8">Limitation of Liability</h2>
          <p>
          ...
          <h2 className="text-xl pt-8">Governing Law</h2>
          <p>
          ...
          <h2 className="text-xl pt-8">Disputes Resolution</h2>
          <p>
            If You have any concern or dispute about the Service, You agree to
            first try to resolve the dispute informally by contacting the
            Company.
          </p>
          <h2 className="text-xl pt-8">For European Union (EU) Users</h2>
          <p>
            If You are a European Union consumer, you will benefit from any
            mandatory provisions of the law of the country in which you are
            resident in.
          </p>
          <h2 className="text-xl pt-8">United States Legal Compliance</h2>
          <p>
          ...
          <h2 className="text-xl pt-8">Severability and Waiver</h2>
          <h3 className="text-lg">Severability</h3>
          <p>
          ...
          <h3 className="text-lg">Waiver</h3>
          <p>
          ...
          <h2 className="text-xl pt-8">Translation Interpretation</h2>
          <p>
          ...
          <h2 className="text-xl pt-8">Contact Us</h2>
          <p>
            If you have any questions about these Terms and Conditions, You can
            contact us:
          </p>
          <ul>
            <li>By email: toc@getcryptoreach.xyz</li>
          </ul>
        </div>
      </div>
    </div>
